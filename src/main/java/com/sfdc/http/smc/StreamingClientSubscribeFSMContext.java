 ...
 * from file : StreamingClientSubscribeFSM.sm
 */
...
public class StreamingClientSubscribeFSMContext
        extends statemap.FSMContext {
//---------------------------------------------------------------
// Member methods.
//

    public StreamingClientSubscribeFSMContext(StreamingClient owner) {
        super(FSM.Initial);

        _owner = owner;
    }

    public StreamingClientSubscribeFSMContext(StreamingClient owner, StreamingClientState initState) {
        super(initState);
...
//
    ...
    public static abstract class StreamingClientState
        ...
        protected void Entry(StreamingClientSubscribeFSMContext context) {
        }

        protected void Exit(StreamingClientSubscribeFSMContext context) {
        }

        protected void on500Error(StreamingClientSubscribeFSMContext context, Response response) {
            Default(context);
        }

        protected void onConnectComplete(StreamingClientSubscribeFSMContext context) {
            Default(context);
        }

        protected void onFinishedScenario(StreamingClientSubscribeFSMContext context) {
            Default(context);
        }

        protected void onHandshakeComplete(StreamingClientSubscribeFSMContext context, List<Cookie> cookies, String clientId) {
            Default(context);
        }

        protected void onInvalidAuthCredentials(StreamingClientSubscribeFSMContext context, Response response) {
            Default(context);
        }

        protected void onOtherHttpErrorCode(StreamingClientSubscribeFSMContext context, Response response) {
            Default(context);
        }

        protected void onReconnectRequest(StreamingClientSubscribeFSMContext context) {
            Default(context);
        }

        protected void onStartingConnect(StreamingClientSubscribeFSMContext context, Future<Response> future) {
            Default(context);
        }

        protected void onStartingHandshake(StreamingClientSubscribeFSMContext context, Future<Response> future) {
            Default(context);
        }

        protected void onStartingSubscribe(StreamingClientSubscribeFSMContext context, Future<Response> future) {
            Default(context);
        }

        protected void onSubscribeComplete(StreamingClientSubscribeFSMContext context) {
            Default(context);
        }

        protected void onUnknownClientId(StreamingClientSubscribeFSMContext context, Response response) {
            Default(context);
        }

        protected void Default(StreamingClientSubscribeFSMContext context) {
